...
本项目为独立维护的下游衍生项目；当前实现主要同步自 [CS2-Bot-Improver-Plus](https://github.com/numakkiyu/CS2-Bot-Improver-Plus)，其基础来自 [CS2-Bot-Improver](https://github.com/ed0ard/CS2-Bot-Improver)。本项目与上述上游项目不存在隶属关系。
