...
This project is independently maintained as a downstream derivative. Its current implementation is synchronized from [CS2-Bot-Improver-Plus](https://github.com/numakkiyu/CS2-Bot-Improver-Plus), which in turn builds on [CS2-Bot-Improver](https://github.com/ed0ard/CS2-Bot-Improver). It is not affiliated with either upstream project.
